...
int main()
{
	...
	std::cout << "Result of Xor test- " << Test_Xor1(character_1, character_2, Test) << std::endl;

	std::cout << "Result of Or test- " << Test_Or1(character_1, character_2, Test) << std::endl;

	std::cout << "Result of And test- " << Test_And1(character_1, character_2, Test) << std::endl;

	std::cout << "Result of Not test- " << Test_Not1(character_1, Test) << std::endl;
